...
module.exports.sretrieveUser = async (req, res, next) => {
  const { username, offset = 0 } = req.params;
  const requestingUser = req.user;
  try {
    const user = await User.findOne(
      { username },
      'schoolOrUniversityName username avatarPic about location email _id phone website backgroundPic '
    );
    if (!user) {
      return res
        .status(404)
...
module.exports.sretrievePosts = async (req, res, next) => {
  const { username, offset = 0 } = req.params;
  try {
   const posts = await Post.aggregate([
      { $sort: { date: -1 } },
...
module.exports.sretrieveJobs = async (req, res, next) => {
...
module.exports.sretrieveCommits = async (req, res, next) => {
  const { username, offset = 0 } = req.params;
  try {
...
module.exports.sretrieveDescriptions = async (req, res, next) => {
  const { schoolOrUniversityName, offset = 0 } = req.params;
  try {
...
module.exports.sretrieveEvents = async (req, res, next) => {
  const { schoolOrUniversityName, offset = 0 } = req.params;
  try {
   const events = await Event.aggregate([
      { $sort: { date: -1 } },
...
module.exports.sbookmarkPost = async (req, res, next) => {
...
module.exports.sfollowUser = async (req, res, next) => {
...
module.exports.sretrieveFollowers = async (req, res, next) => {
  const { userId, offset = 0 } = req.params;
  const user = req.user;
...
module.exports.ssearchUsers = async (req, res, next) => {
  const { username, offset = 0 } = req.params;
  if (!username) {
    return res
      .status(400)
...
module.exports.sconfirmUser = async (req, res, next) => {
...
module.exports.schangeAvatar = async (req, res, next) => {
  const user = req.user;
...
module.exports.schangeBackground = async (req, res, next) => {
  const user = req.user;
...
module.exports.sremoveAvatar = async (req, res, next) => {
  const user = req.user;
...
module.exports.sremoveBackground = async (req, res, next) => {
  const user = req.user;
...
module.exports.supdateProfile = async (req, res, next) => {
  const user = req.user;
...
module.exports.sretrieveSuggestedUsers = async (req, res, next) => {
